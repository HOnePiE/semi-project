                        ...
                        <tbody>
                            @foreach (session('cart', []) as $productId => $item)
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="updateCartItem({{ $productId }})">Update</button>
                            ...
                            @foreach (session('cart', []) as $productId => $item)
                                <tr class="rem1">
                                    ...
                                    <td class="invert-image"><a href="{{ route('single') }}"><img src="/images/s1.jpg"
                                    ...
                                    <td class="invert">
                                        <div class="rem">
                                            <div class="close1"> <button onclick="removeCartItem({{ $productId }})">Remove</button> </div>
                                        </div>
